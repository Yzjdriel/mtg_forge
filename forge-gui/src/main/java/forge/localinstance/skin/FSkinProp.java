...
public enum FSkinProp {
    ...
    public static final Map<ManaCostShard, FSkinProp> SHARD_IMG = ImmutableMap.<ManaCostShard, FSkinProp>builder()
            ...
            .put(ManaCostShard.WH, IMG_MANA_PHRYX_W)
            .put(ManaCostShard.UH, IMG_MANA_PHRYX_U)
            .put(ManaCostShard.BH, IMG_MANA_PHRYX_B)
            .put(ManaCostShard.RH, IMG_MANA_PHRYX_R)
            .put(ManaCostShard.GH, IMG_MANA_PHRYX_G)

            .put(ManaCostShard.BGH, IMG_MANA_PHRYX_BG)
            .put(ManaCostShard.BRH, IMG_MANA_PHRYX_BR)
            .put(ManaCostShard.GUH, IMG_MANA_PHRYX_GU)
            .put(ManaCostShard.GWH, IMG_MANA_PHRYX_GW)
            .put(ManaCostShard.RGH, IMG_MANA_PHRYX_RG)
            .put(ManaCostShard.RWH, IMG_MANA_PHRYX_RW)
            .put(ManaCostShard.UBH, IMG_MANA_PHRYX_UB)
            .put(ManaCostShard.URH, IMG_MANA_PHRYX_UR)
            .put(ManaCostShard.WBH, IMG_MANA_PHRYX_WB)
            .put(ManaCostShard.WUH, IMG_MANA_PHRYX_WU)
